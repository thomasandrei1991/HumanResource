<?php
    ...
    if ($departmentName !== '') {
        // TOTAL EMPLOYEES
        $totalQuery = mysqli_prepare($conn, "SELECT COUNT(*) AS total
            FROM employees
        ...
        // ACTIVE EMPLOYEES
        $activeQuery = mysqli_prepare($conn, "SELECT COUNT(*) AS total
            FROM employees
            WHERE LOWER(department) = LOWER(?)
        ...
        // ON LEAVE EMPLOYEES
        $onLeaveQuery = mysqli_prepare($conn, "SELECT COUNT(*) AS total
            FROM employees
            WHERE LOWER(department) = LOWER(?)
    ...
    // ==========================================================
    if ($departmentName !== '') {
        $leaveQuery = mysqli_prepare($conn, "SELECT COUNT(*) AS total
...
<head>
    ...
    <link rel="stylesheet" href="styles/department_head_dashboard.css">
