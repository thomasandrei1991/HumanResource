    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-container">
            ...
            <div class="employee-form-panel">
                ...
                <form
                    action="edit_department_process.php"
                    method="POST"
                >
                    ...
                    <div class="input-group">
                        ...
                        <input
                            ...
                            class="inputs"
                            value="<?php echo htmlspecialchars($department['department_head']); ?>"
                    ...
                    <div class="input-group">
                        ...
                        >
                            ...
                            <option
                                value="Inactive"
                                <?php
                                echo $department['status'] === 'Inactive'
                                    ? 'selected'
                                    : '';
                                ?>
                            >
