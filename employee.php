...
|--------------------------------------------------------------------------
|
| Only Admin and HR are allowed to access employee.php.
|
*/
...
<body
    ...
    data-show-form="<?php
        echo isset($_SESSION['employee_error']) ? '1' : '0';
    ?>"
    data-show-modal="<?php
        echo isset($_SESSION['employee_error']) ? '1' : '0';
    ?>"
    data-modal-title="Duplicate Employee ID"
    data-modal-message="<?php
        echo isset($_SESSION['employee_error'])
            ? htmlspecialchars(
