                                ...
                                <?php if ($isAdminOrHR): ?>
                                    <td class="actions-cell">
                                        ...
                                        <form action="employee.php" method="GET" style="display:inline;">
                                            <input type="hidden" name="edit_id" value="<?php echo intval($row['id']); ?>">
                                            <button type="submit" class="edit-btn" data-employee-id="<?php echo intval($row['id']); ?>">
                                                ✏️ Edit
                                            </button>
                                        </form>

                                        <!-- DELETE
                                             FIX: the opening <a> tag was missing, leaving a floating
                                             attribute list followed by a stray closing </a>. Restored it. -->
                                        
                                        <a href="#"
                                            class="employee-delete-btn"
                                            data-id="<?php echo intval($row['id']); ?>"
                                            data-type="employee"
                                            data-name="<?php echo htmlspecialchars($row['firstname'] . ' ' . $row['lastname'], ENT_QUOTES, 'UTF-8'); ?>"
                                        >
                                            🗑️ Delete
                                        </a>
