...
$attendanceResult = mysqli_stmt_get_result(
    $attendanceQuery
);
            ...
            <div class="employee-panel">
                ...
                <div class="attendance-actions">
                    ...
                    <?php if (!$todayAttendance): ?>
                        ...
                        <a
                            href="add_employee_attendance.php"
                            class="primary-btn"
                        >
                            🕐 Time In
                        </a>
                    ...
                    <?php elseif (empty($todayAttendance['time_out'])): ?>
                        ...
                        <a
                            href="update_employee_attendance.php"
                            class="primary-btn"
                        >
                            🕐 Time Out
                        </a>
                ...
                <div class="attendance-status">
                    ...
                    <p>
                        ...
                        if (
                            $todayAttendance &&
                            !empty($todayAttendance['time_out'])
                        ) {
        ...
        <div class="employee-panel">
            ...
            <table class="dashboard-table employee-table">
                ...
                <tbody>
                    ...
                    $historyResult = mysqli_stmt_get_result(
                        $historyQuery
                    );


                    if (
                        mysqli_num_rows($historyResult) > 0
                    ):
