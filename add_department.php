<div id="addDepartmentFormPanel" class="employee-form-panel hidden">
    ...
    <form action="add_department_process.php" method="POST" id="addDepartmentForm">
        ...
        <div class="input-group">
            ...
            <input type="text" id="departmentName" name="department_name" class="inputs" placeholder="Enter department name" required>
        </div>

        <div class="input-group">
            <label for="departmentHead">Department Head</label>
            <input type="text" id="departmentHead" name="department_head" class="inputs" placeholder="Enter department head">
        </div>
