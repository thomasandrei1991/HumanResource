<?php
    ...
    $departmentQuery = mysqli_query($conn, "SELECT id, department_name
        FROM departments
        WHERE status = 'Active'
    ...
    <main class="dashboard-main">
        <div class="dashboard-container">
            <div class="employee-form-panel">
                ...
                <form action="add_department_head_process.php" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <select id="department_id" name="department_id" class="inputs" required>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="fullname" name="fullname" class="inputs" placeholder="Enter department head name" required>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="username" name="username" class="inputs" placeholder="Enter username" required>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="password" name="password" class="inputs" placeholder="Enter password" required>
                    </div>
